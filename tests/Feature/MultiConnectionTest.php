...
namespace SocialiteProviders\OpenIDConnect\Tests\Feature;
...
use SocialiteProviders\OpenIDConnect\Tests\Support\CustomProvider;
...
class MultiConnectionTest extends TestCase
{
    ...
    public function test_a_provider_shorthand_resolves_to_the_built_in_class_with_derived_config(): void
    {
        ...
        $this->assertSame(
            \SocialiteProviders\OpenIDConnect\IssuerValidators\EntraIssuerValidator::class,
